...
func FetchAll_MinitPasaran(client_company, pasaran_code, permainan string) (Response, error) {
...
func Fetch_LimitTransaksiPasaran432(client_username, client_company, pasaran_code, pasaran_periode, tipe_game string) (Response, error) {
